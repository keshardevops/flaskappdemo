...
class RegistrationForm(Form):
	...
	accept_tos = BooleanField('I accept the <a href="/tos/">Terms of Service</a> and the <a href="/privacy/">Privacy Notice</a> (Last updated Oct 7, 2015)', [validators.Required()])
...
def Introduction_to_Python():
	...
	# print ("\n" * 10 + os.path.realpath(".") + "\n" * 10)
	print ("\n" * 10 + app.root_path + "\n" * 10)
	return render_template("tutorials/Basics/introduction-to-python-programming.html", completed_percentages= completed_percentages,
		curLink = TOPIC_DICT["Basics"][0][1], curTitle=TOPIC_DICT["Basics"][0][0], nextLink = TOPIC_DICT["Basics"][1][1], nextTitle = TOPIC_DICT["Basics"][1][0])
...
def Print_functions_and_Strings():
	...
	completed_percentages = topic_completion_percent()
	print ("\n" * 10 + app.root_path + "\n" * 10)
	return render_template("tutorials/Basics/python-tutorial-print-function-strings.html", completed_percentages= completed_percentages,
		curLink = TOPIC_DICT["Basics"][1][1], curTitle=TOPIC_DICT["Basics"][1][0], nextLink = TOPIC_DICT["Basics"][2][1], nextTitle = TOPIC_DICT["Basics"][2][0])
...
def Math_basics_with_Python_3():
	update_user_tracking()
	completed_percentages = topic_completion_percent()
	return render_template("tutorials/Basics/math-basics-python-3-beginner-tutorial.html", completed_percentages= completed_percentages,
		curLink = TOPIC_DICT["Basics"][2][1], curTitle=TOPIC_DICT["Basics"][2][0], nextLink = TOPIC_DICT["Basics"][3][1], nextTitle = TOPIC_DICT["Basics"][3][0])
...
def Varaibles():
	update_user_tracking()
	completed_percentages = topic_completion_percent()
	return render_template("tutorials/Basics/python-3-variables-tutorial.html", completed_percentages= completed_percentages,
